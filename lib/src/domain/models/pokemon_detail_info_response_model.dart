...
class PokemonDetailInfoResponseModel {
  ...
  PokemonDetailInfoResponseModel({
    this.abilities,
    this.baseExperience,
    this.forms,
    this.gameIndices,
  ...
  factory PokemonDetailInfoResponseModel.fromRawJson(String str) => PokemonDetailInfoResponseModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PokemonDetailInfoResponseModel.fromJson(Map<String, dynamic> json) => PokemonDetailInfoResponseModel(
